...
public class InvoiceServiceTest {
    ...
    public static void setUp() {
        ...
        all.add(new Invoice(1, 0L, "address", "address", new User(1), new Shop(1), null));
        all.add(new Invoice(1, 0L, "address", "address", new User(2), new Shop(2), null));
        all.add(new Invoice(1, 0L, "address", "address", new User(3), new Shop(3), null));
    }
